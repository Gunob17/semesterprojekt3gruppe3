...
void MainWindow::on_Xinput_valueChanged(int arg1) {
	...
	ui->Xinput->setRange((y_spin - 670.3576) / -1.030905, (y_spin - 1760.499) / -1.030369);
	//Qlabel* label
...
void MainWindow::on_Yinput_valueChanged(int arg1) {
	...
	ui->Xinput->setRange((y_spin - 670.3576) / -1.030905, (y_spin - 1760.499) / -1.030369);
	//Qlabel* label
	ui->label2->setText("x axis has to be between: " + QString::number((y_spin - 670.3576) / -1.030905) + " and: " + QString::number((y_spin - 1760.499) / -1.030369));
}