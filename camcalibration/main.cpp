...
public:
    ...
    void interprate()
    {
        ...
        else
        {
            ...
            if (inputType != IMAGE_LIST && !inputCapture.isOpened())
                    inputType = INVALID;
            //inputCapture.set(CAP_PROP_EXPOSURE, 0.00000001);
            //inputCapture.set(CAP_PROP_GAIN, 0.000000001);
            //inputCapture.set(CV_CAP_PROP_FRAME_WIDTH,1448);
    ...
    Mat nextImage()
    {
        ...
        if( inputCapture.isOpened() )
        {
            ...
            inputCapture >> view0;
            //indtat kode
            //resize(view0,view0, Size(1448/1.5,1080/1.5));
            view0.copyTo(result);
        }
...
int main(int argc, char* argv[])
{
    help();
    Settings s;
    const string inputSettingsFile = argc > 1 ? argv[1] : "C:/Users/gusta/Documents/GitHub/semesterprojekt3gruppe3/calibration.xml";
    ...
    for(int i = 0;;++i)
    {
      ...
      if(view.empty())          // If no more images then run calibration, save and stop loop.
      {
        ...
        //resize(view,view,Size(1448/2,1080/2));
